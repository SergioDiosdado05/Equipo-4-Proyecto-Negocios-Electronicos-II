...
if(!isset($_SESSION['AdministradorCorreo'])){
    ...
    $admin_session= implode(" ", $_SESSION['AdministradorCorreo']);
    ...
    $get_bitacora="select * from bitacora";
    $run_bitacora= mysqli_query($con,$get_bitacora);
    $count_bitacora=  mysqli_num_rows($run_bitacora);
...
<div id="wrapper"> <!-- Wrapper Begin -->
    ...
    <div id="page-wrapper">   <!-- Page Wrapper Begin -->
        <div id="container-fluid>"> <!--container-fluid Begin -->
            ...
            }if(isset($_GET['Ver_bitacora'])){

                include("Ver_bitacora.php");
